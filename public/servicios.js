                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-6">
                            <div class="card-body text-center">
                                <h5 class="card-title" style="font-size: 1.5vw; margin-bottom: 0; color: #000; font-weight: bold;">${producto.nombre}</h5>
                                <p class="card-text" style="color: #ff8c00; margin-bottom: 5px; margin-top: 5px; font-size: 1.2vw; font-weight: bold;">Precio: L. ${producto.precio.toFixed(2)}</p>
                                <p class="card-text" style="font-size: 1vw;">${producto.descripcion}</p>
                                <a href="#" class="btn btn-primary" style="width: 100%; padding: 6px 0; margin-top: 5px; font-size: 1vw;">Contratar Servicio</a>
                            </div>
                        </div>
                    </div>
                </div>
